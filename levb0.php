...
if(isset($_POST['submit'])){
		...
		<div class="score"><?php echo "SCORE IN LEVEL 1 : ".$result;?></div>
		<?php
		$name=$_SESSION['username'];


		$sql="UPDATE user2 SET score1='$result' WHERE username='".$name."'";
		$queryresult=mysqli_query($con,$sql);
		$sql="UPDATE user2 SET score=(score1+score2+score3+score4) WHERE username='".$name."'";
		$queryresult=mysqli_query($con,$sql);
		$sql="UPDATE user2 SET level='1' WHERE username='".$name."'";
		$queryresult=mysqli_query($con,$sql);
		mysqli_close($con);
	}
		?>
		<br><br>
		<center><a href="lev2.php"><button type="button" class="btn btn-warning" style="font-family: cursive;color: white;">NEXT</button></a></center><br><br><br>
