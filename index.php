...
<body>
  ...
  <div class="lin"><center>New user? Click <a href="signup.php" class="li" >HERE</a> to register<center></div>
</header>
</body>
<?php

$con=mysqli_connect("fdb26.awardspace.net","3071595_sush","susmita@1","3071595_sush");
